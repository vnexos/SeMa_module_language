...
public class Language extends DefaultEntity {
  ...
  public Language(String code, String name, String flagUrl, String description, boolean isDefault, boolean isRightToLeft) {
    this.code = code;
    this.name = name;
  ...
  public Language(UUID id, String code, String name, String flagUrl, String description, boolean isDefault, boolean isRightToLeft) {
